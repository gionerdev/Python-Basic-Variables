...
# esto es debido a su tipado dinámico en donde puede tomar distintos datos sin necesidad de especificar
...
message2 = """Hello World, my name is Gioner
and this is a test in Python."""  
...
# Desempaquetar un dato, los datos de una colección o un string pueden ser vinculados a otra variable
